  ...
  var tasks = new listr_1.default(
    apis.map(function (api) {
      return {
        ...
        task: function () {
          return execa_1.default('./node_modules/.bin/ng-openapi-gen', ['-c', api.openapiGen]).then();
        },
      };
    }),
...
exports.execute = function (options) {
  ...
  if (options.selection) {
    var filteredConfigurations = options.configurations.filter(function (configuration) {
      return options.selection.indexOf(configuration.name) !== -1;
    });
